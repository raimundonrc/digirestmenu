...
function abrirModalAlteraSubgrupo(id, descricao, ativo, mostra_imagem){
    ...
    mostra_imagem ? document.querySelector('#mostra_imagem_edit').checked = true : 
        document.querySelector('#mostra_imagem_edit').checked = false;
