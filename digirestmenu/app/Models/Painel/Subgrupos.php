<?php 
    ...
    class Subgrupos{
        ...
        public function getAll(){
            $query = 'SELECT id, descricao, ordem, ativo, data_criacao, data_update FROM tb_subgrupos ORDER BY ordem';
        ...
        public function getAllActive(){
            $query = 'SELECT id, descricao, ordem, ativo, data_criacao, data_update FROM tb_subgrupos WHERE ativo = TRUE ORDER BY ordem';
        ...
        public function insertSubgrupo(){
            ...
            $query = 'INSERT INTO tb_subgrupos (descricao, ordem) VALUES  (:descricao, :ordem)';
            $con = new Connection;
        ...
        public function setSubgrupo(){
            $query = 'UPDATE tb_subgrupos SET descricao = :descricao, ativo = :ativo WHERE id IN(:id)';           
