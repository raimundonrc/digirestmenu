    ...
    class PainelController{
        ...
        public function insertReserva(){
            ...
            if($validNome && $validTel && $validTel && $validData && $validHorario){
                ...
                $_POST['add-observacao'] ? $reserva->__set('observacao', $_POST['add-observacao']) : $reserva->__set('observacao', null);
        ...
        public function insertSubgrupo(){
            ...
            if($validDescricao){
                ...
                isset($_POST['mostra_imagem']) && $_POST['mostra_imagem'] == 'on' ?  $subgrupos->__set('aparece_imagem', true) : $subgrupos->__set('aparece_imagem', false);
